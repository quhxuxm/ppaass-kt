...
internal val HTTP_CONNECTION_KEEP_ALIVE = AttributeKey.valueOf<Boolean>("HTTP_CONNECTION_KEEP_ALIVE")
internal val PROXY_CHANNEL_ACTIVE_CALLBACK = AttributeKey.valueOf<(proxyChannelContext: ChannelHandlerContext) -> Unit>("PROXY_CHANNEL_ACTIVE_CALLBACK")
