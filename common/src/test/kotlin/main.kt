...
fun main(args: Array<String>) {
    val agentMessage = AgentMessage("securetoken", MessageBodyEncryptionType.BASE64_AES,
    ...
    val proxyMessage = ProxyMessage("securetoken", MessageBodyEncryptionType.BASE64_AES,
